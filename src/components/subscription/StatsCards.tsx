            ...
            {shouldShowCredits ? (
                <>
                    ...
                    <div className="bg-white border border-gray-200 rounded-xl p-6 flex flex-col h-full">
                        ...
                        <div className="flex flex-col items-center justify-center flex-1">
                            <div className="text-3xl font-bold text-brand-primary">
                                {isQuotaLoading ? "-" : String((freeTryOnQuota ?? 0) * 5)}
                            </div>
                        ...
                        <div className="mt-auto pt-4">
                            <div className="text-xs text-gray-500 inline-flex items-center justify-center gap-1 w-full">
                                <Tooltip
                                    title={
                                        <div>
                                            <div>1 try-on costs 5 credits</div>
                                            <div>1 size recommendation costs 1 credit</div>
                                        </div>
                                    }
                                >
                            ...
                            <div className="bg-white/60 rounded-lg p-3 mb-3">
                                <div className="space-y-2">
                                    <div className="flex items-center justify-between text-xs">
                                        ...
                                        <span className="font-medium text-gray-800">2 try-ons • 10 size recs</span>
                                    </div>
                                    <div className="flex items-center justify-between text-xs">
                                        <div className="flex items-center gap-1">
                                        ...
                                        <span className="font-medium text-gray-800">10 try-ons • 50 size recs</span>
                                    </div>
                                </div>
                            </div>
